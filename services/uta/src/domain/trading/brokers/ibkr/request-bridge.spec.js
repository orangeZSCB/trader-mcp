...
function pushUpdate(b, contract, qty, avgCost = '100') {
...
describe('RequestBridge — account cache delta semantics', () => {
    function readyBridge() {
        const b = new RequestBridge();
        b.accountCachePending_ = { positions: [], values: new Map() };
...
//# sourceMappingURL=request-bridge.spec.js.map