...
export function qtyToWei(qty) {
    return decimalToWei(qty, QTY_DECIMALS);
}
export function weiToQty(wei) {
    return weiToDecimal(wei, QTY_DECIMALS);
}
export function priceToWei(price) {
    return decimalToWei(price, PRICE_DECIMALS);
}
export function weiToPrice(wei) {
    return weiToDecimal(wei, PRICE_DECIMALS);
}
export function amountInToWei(amount, tokenDecimals) {
    return decimalToWei(amount, tokenDecimals);
}
export function weiToAmountIn(wei, tokenDecimals) {
