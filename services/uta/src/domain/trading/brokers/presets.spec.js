...
import { BROKER_PRESET_CATALOG, getBrokerPreset, isPaperPreset, deriveUtaId, BINANCE_PRESET, OKX_PRESET, BYBIT_PRESET, HYPERLIQUID_PRESET, BITGET_PRESET, ALPACA_PRESET, IBKR_PRESET, LONGBRIDGE_PRESET, CCXT_CUSTOM_PRESET, SIMULATOR_PRESET, BUILTIN_BROKER_PRESETS, } from '@traderalice/uta-protocol';
...
describe.each(BROKER_PRESET_CATALOG)('preset $id', (preset) => {
    ...
    it('toEngineConfig output is accepted by the target engine schema', () => {
        const parsed = preset.zodSchema.parse(sample);
...
describe('BUILTIN_BROKER_PRESETS', () => {
    ...
    it('Mode field becomes oneOf with title labels (so the wizard renders human-readable options)', () => {
        ...
        const props = okx.schema.properties;
...
//# sourceMappingURL=presets.spec.js.map