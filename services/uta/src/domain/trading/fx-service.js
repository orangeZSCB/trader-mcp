...
export class FxService {
     ...
     */
    constructor(currencyClient, ttlMs = 5 * 60_000, hub) {
    ...
    async hubRate(key) {
        ...
        try {
            ...
            if (data?.counter !== 'USD' || !data.rates)
                throw new Error('non-contract shape');
            const rates = {};
