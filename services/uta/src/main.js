...
import { loadConfig, readUTAsConfig, purgeEphemeralUTAs } from '@openalice-trading/alice-core/core/config.js';
import { parseDuration } from '@openalice-trading/alice-core/core/duration.js';
import { createEventLog } from '@openalice-trading/alice-core/core/event-log.js';
import { ToolCenter } from '@openalice-trading/alice-core/core/tool-center.js';
...
import { getSDKExecutor, buildRouteMap, SDKCurrencyClient, } from '@openalice-trading/alice-core/domain/market-data/client/typebb/index.js';
...
async function main() {
    ...
    const dataUTAs = ['binance', 'okx', 'bybit']
    ...
    const shutdown = async (signal) => {
        ...
        server.close();
        await utaManager.closeAll().catch(() => { });
