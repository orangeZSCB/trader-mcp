...
import { getSDKExecutor, buildRouteMap, SDKEquityClient, SDKCryptoClient, SDKCurrencyClient, SDKCommodityClient, SDKEtfClient, SDKIndexClient, SDKDerivativesClient, SDKEconomyClient, } from '@openalice-trading/alice-core/domain/market-data/client/typebb/index.js';
...
async function waitForUtaHealth() {
    ...
    throw new Error(`UTA did not become ready within ${HEALTH_TIMEOUT_MS}ms` +
        (lastError instanceof Error ? `: ${lastError.message}` : ''));
}
// ==================== MCP server ====================
function buildMcpServer(manager, marketDeps) {
