...
export interface FetcherClass {
    ...
    extractData(query: unknown, credentials: Record<string, string> | null): Promise<unknown>;
    ...
    fetchData(params: Record<string, unknown>, credentials?: Record<string, string> | null): Promise<unknown>;
}
/**
...
export declare abstract class Fetcher {
    ...
    static extractData(_query: unknown, _credentials: Record<string, string> | null): Promise<unknown>;
     ...
     */
    static fetchData(params: Record<string, unknown>, credentials?: Record<string, string> | null): Promise<unknown>;
}
