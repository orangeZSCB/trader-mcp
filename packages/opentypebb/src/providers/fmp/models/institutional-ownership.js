...
export class FMPInstitutionalOwnershipFetcher extends Fetcher {
    ...
    static async extractData(query, credentials) {
        ...
        const results = [];
        const settled = await Promise.allSettled(symbols.map(symbol => getDataMany(`https://financialmodelingprep.com/stable/institutional-ownership/symbol-positions-summary?symbol=${symbol}&year=${year}&quarter=${quarter}&apikey=${apiKey}`)));
