...
export declare const FMPCryptoHistoricalQueryParamsSchema: z.ZodObject<{
...
export declare const FMPCryptoHistoricalDataSchema: z.ZodObject<{
    date: z.ZodString;
...
export declare class FMPCryptoHistoricalFetcher extends Fetcher {
    static transformQuery(params: Record<string, unknown>): FMPCryptoHistoricalQueryParams;
    static extractData(query: FMPCryptoHistoricalQueryParams, credentials: Record<string, string> | null): Promise<Record<string, unknown>[]>;
    static transformData(query: FMPCryptoHistoricalQueryParams, data: Record<string, unknown>[]): FMPCryptoHistoricalData[];
}
