...
export class FMPExecutiveCompensationFetcher extends Fetcher {
    ...
    static async extractData(query, credentials) {
        ...
        const results = [];
        const settled = await Promise.allSettled(symbols.map(symbol => getDataMany(`https://financialmodelingprep.com/stable/governance-executive-compensation?symbol=${symbol}&apikey=${apiKey}`)));
...
//# sourceMappingURL=executive-compensation.js.map