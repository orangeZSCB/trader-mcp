...
export class DeribitOptionsChainsFetcher extends Fetcher {
    ...
    static async extractData(query, _credentials) {
        ...
        if (results.length === 0)
            throw new EmptyDataError('No options data found.');
        return results;
    }
    static transformData(query, data) {
        return data.map(d => {
            ...
            const underlyingPrice = d.underlying_price;
            const indexPrice = d.index_price;
            ...
            return OptionsChainsDataSchema.parse({
                ...
                volume: d.stats ? d.stats.volume ?? null : null,
                last_trade_price: d.last_price != null ? d.last_price * refPrice : null,
                bid: d.best_bid_price != null ? d.best_bid_price * refPrice : null,
                bid_size: d.best_bid_amount ?? null,
                ask: d.best_ask_price != null ? d.best_ask_price * refPrice : null,
                ask_size: d.best_ask_amount ?? null,
                mark: d.mark_price != null ? d.mark_price * refPrice : null,
                implied_volatility: d.mark_iv != null ? d.mark_iv / 100 : null,
                delta: d.greeks ? d.greeks.delta ?? null : null,
                gamma: d.greeks ? d.greeks.gamma ?? null : null,
                theta: d.greeks ? d.greeks.theta ?? null : null,
                vega: d.greeks ? d.greeks.vega ?? null : null,
                rho: d.greeks ? d.greeks.rho ?? null : null,
            });
        });
    }
}
//# sourceMappingURL=options-chains.js.map