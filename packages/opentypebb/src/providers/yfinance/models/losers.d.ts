...
export declare const YFLosersQueryParamsSchema: z.ZodObject<{
...
export declare const YFLosersDataSchema: z.ZodObject<{
    symbol: z.ZodString;
...
export declare class YFLosersFetcher extends Fetcher {
    static requireCredentials: boolean;
    static transformQuery(params: Record<string, unknown>): YFLosersQueryParams;
    static extractData(query: YFLosersQueryParams, credentials: Record<string, string> | null): Promise<Record<string, unknown>[]>;
    static transformData(query: YFLosersQueryParams, data: Record<string, unknown>[]): YFLosersData[];
}
