...
export declare const YFAggressiveSmallCapsQueryParamsSchema: z.ZodObject<{
...
export type YFAggressiveSmallCapsQueryParams = z.infer<typeof YFAggressiveSmallCapsQueryParamsSchema>;
export declare const YFAggressiveSmallCapsDataSchema: z.ZodObject<{
    symbol: z.ZodString;
...
export type YFAggressiveSmallCapsData = z.infer<typeof YFAggressiveSmallCapsDataSchema>;
export declare class YFAggressiveSmallCapsFetcher extends Fetcher {
    static requireCredentials: boolean;
    static transformQuery(params: Record<string, unknown>): YFAggressiveSmallCapsQueryParams;
    static extractData(query: YFAggressiveSmallCapsQueryParams, credentials: Record<string, string> | null): Promise<Record<string, unknown>[]>;
    static transformData(query: YFAggressiveSmallCapsQueryParams, data: Record<string, unknown>[]): YFAggressiveSmallCapsData[];
}
