...
export declare const YFGrowthTechQueryParamsSchema: z.ZodObject<{
...
export declare const YFGrowthTechDataSchema: z.ZodObject<{
    symbol: z.ZodString;
...
export declare class YFGrowthTechEquitiesFetcher extends Fetcher {
    static requireCredentials: boolean;
    static transformQuery(params: Record<string, unknown>): YFGrowthTechQueryParams;
    static extractData(query: YFGrowthTechQueryParams, credentials: Record<string, string> | null): Promise<Record<string, unknown>[]>;
    static transformData(query: YFGrowthTechQueryParams, data: Record<string, unknown>[]): YFGrowthTechData[];
}
