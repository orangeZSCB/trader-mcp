 ...
 */
function formatFuturesSymbols(symbols, expiration) {
    const newSymbols = [];
...
export class YFinanceFuturesHistoricalFetcher extends Fetcher {
    ...
    static async extractData(query, credentials) {
        ...
        if (!allData.length)
            throw new EmptyDataError('No futures historical data returned');
        return allData;
    }
...
//# sourceMappingURL=futures-historical.js.map