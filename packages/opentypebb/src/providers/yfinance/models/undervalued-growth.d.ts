...
export declare const YFUndervaluedGrowthQueryParamsSchema: z.ZodObject<{
...
export declare const YFUndervaluedGrowthDataSchema: z.ZodObject<{
    symbol: z.ZodString;
...
export declare class YFUndervaluedGrowthEquitiesFetcher extends Fetcher {
    static requireCredentials: boolean;
    static transformQuery(params: Record<string, unknown>): YFUndervaluedGrowthQueryParams;
    static extractData(query: YFUndervaluedGrowthQueryParams, credentials: Record<string, string> | null): Promise<Record<string, unknown>[]>;
    static transformData(query: YFUndervaluedGrowthQueryParams, data: Record<string, unknown>[]): YFUndervaluedGrowthData[];
}
