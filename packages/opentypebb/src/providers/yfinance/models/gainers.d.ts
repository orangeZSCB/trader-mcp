...
export declare const YFGainersQueryParamsSchema: z.ZodObject<{
...
export declare const YFGainersDataSchema: z.ZodObject<{
    symbol: z.ZodString;
...
export declare class YFGainersFetcher extends Fetcher {
    static requireCredentials: boolean;
    static transformQuery(params: Record<string, unknown>): YFGainersQueryParams;
    static extractData(query: YFGainersQueryParams, credentials: Record<string, string> | null): Promise<Record<string, unknown>[]>;
    static transformData(query: YFGainersQueryParams, data: Record<string, unknown>[]): YFGainersData[];
}
