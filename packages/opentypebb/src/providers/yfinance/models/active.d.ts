...
export declare const YFActiveQueryParamsSchema: z.ZodObject<{
...
export declare const YFActiveDataSchema: z.ZodObject<{
    symbol: z.ZodString;
...
export declare class YFActiveFetcher extends Fetcher {
    static requireCredentials: boolean;
    static transformQuery(params: Record<string, unknown>): YFActiveQueryParams;
    static extractData(query: YFActiveQueryParams, credentials: Record<string, string> | null): Promise<Record<string, unknown>[]>;
    static transformData(query: YFActiveQueryParams, data: Record<string, unknown>[]): YFActiveData[];
}
