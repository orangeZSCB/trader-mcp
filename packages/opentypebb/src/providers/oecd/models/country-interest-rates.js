...
const DURATION_MAP = { short: 'IR3TIB', long: 'IRLT' };
...
export class OECDCountryInterestRatesFetcher extends Fetcher {
    ...
    static async extractData(query, _credentials) {
        ...
        const url = `https://sdmx.oecd.org/public/rest/data/OECD.SDD.STES,DSD_KEI@DF_KEI,4.0` +
...
//# sourceMappingURL=country-interest-rates.js.map