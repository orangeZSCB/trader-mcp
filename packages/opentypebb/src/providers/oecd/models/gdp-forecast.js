...
export class OECDGdpForecastFetcher extends Fetcher {
    ...
    static async extractData(query, _credentials) {
        ...
        const rows = await fetchOecdCsv('OECD.SDD.NAD,DSD_NAMAIN1@DF_TABLE1_EXPENDITURE_HCPC,1.0', `${cc}.${freq}.S1.S1.B1GQ._Z._Z._Z.V.GY.`);
        return rows
...
//# sourceMappingURL=gdp-forecast.js.map