...
import { globRss, grepRss, readRss } from './archive';
    ...
    const mockNews = [
        {
            ...
            content: 'Bitcoin has broken the 50k resistance level after weeks of consolidation. Analysts predict further upside.',
        ...
        },
        {
            ...
            content: 'Ethereum announces new upgrade scheduled for Q2. Gas fees expected to decrease significantly.',
            metadata: { source: 'official', category: 'crypto' },
        },
        {
            id: 30,
            ...
            content: 'Analysts predict bullish trend for Bitcoin and altcoins. Interest rate decisions may impact crypto.',
        ...
        },
        {
            ...
            content: 'Asian markets show positive sentiment. BTC trading volume surges in Korea.',
            metadata: { source: 'news', category: 'market' },
        },
    ];
    const createContext = (news = mockNews) => ({
        getNews: async () => news,
    });
    describe('globRss', () => {
