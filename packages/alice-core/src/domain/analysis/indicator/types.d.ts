...
export declare function toValues(input: number[] | TrackedValues): number[];
...
export type ASTNode = NumberNode | StringNode | ArrayNode | FunctionNode | BinaryOpNode | ArrayAccessNode;
