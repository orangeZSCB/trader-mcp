...
function makeDeps(over = {}) {
    ...
    return {
        ...
        equityClient: { getHistorical: equityHist },
        cryptoClient: { getHistorical: cryptoHist },
        currencyClient: { getHistorical: currencyHist },
        commodityClient: { getSpotPrices: commoditySpot },
...
describe('getBars — vendor branch', () => {
    ...
    it('caps at MAX_BARS', async () => {
        ...
        const deps = makeDeps({ equityClient: { getHistorical: async () => big } });
        const svc = createBarService(deps);
