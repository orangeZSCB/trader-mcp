...
import { fetchSectorRotation, type SectorRotationResult } from '@openalice-trading/alice-core/domain/analysis/sector-rotation.js'
import { createHubFetcher, markLocal, type HubConfig } from '@openalice-trading/alice-core/domain/market-data/reference/hub.js'
