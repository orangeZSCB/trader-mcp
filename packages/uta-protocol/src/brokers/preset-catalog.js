...
function defaultIsPaper(data) {
    const mode = String(data['mode'] ?? '').toLowerCase();
    return mode === 'demo' || mode === 'testnet' || mode === 'paper';
}
// ==================== CCXT-engine presets ====================
export const BINANCE_PRESET = {
    id: 'binance',
    label: 'Binance',
...
export const HYPERLIQUID_PRESET = {
    id: 'hyperliquid',
    label: 'Hyperliquid',
...
export const CCXT_CUSTOM_PRESET = {
    id: 'ccxt-custom',
...
export const LONGBRIDGE_PRESET = {
    id: 'longbridge',
...
export const BROKER_PRESET_CATALOG = [
    // ---- Recommended ----
...
export function getBrokerPreset(presetId) {
...
export function isPaperPreset(presetId, presetConfig) {
 ...
 */
export function deriveUtaId(preset, presetConfig) {
    const filtered = {};
...
//# sourceMappingURL=preset-catalog.js.map