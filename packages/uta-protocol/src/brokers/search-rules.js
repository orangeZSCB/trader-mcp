...
const QUOTE_CURRENCIES = ['USDT', 'USDC', 'BUSD', 'USD', 'EUR', 'JPY', 'GBP', 'CNY'];
const QUOTE_SUFFIX_RE = new RegExp(`^([A-Z0-9]{2,})(?:${QUOTE_CURRENCIES.join('|')})$`, 'i');
/**
 ...
 */
export function normalizeBrokerSearchPattern(symbol, assetClass = 'unknown') {
