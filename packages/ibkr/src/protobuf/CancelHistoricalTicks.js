...
function createBaseCancelHistoricalTicks() {
    return { reqId: undefined };
}
export const CancelHistoricalTicks = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelHistoricalTicks();
    ...
    create(base) {
        return CancelHistoricalTicks.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelHistoricalTicks();
...
//# sourceMappingURL=CancelHistoricalTicks.js.map