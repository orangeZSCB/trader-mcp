...
function createBaseCancelHistogramData() {
    return { reqId: undefined };
}
export const CancelHistogramData = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelHistogramData();
    ...
    create(base) {
        return CancelHistogramData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelHistogramData();
...
//# sourceMappingURL=CancelHistogramData.js.map