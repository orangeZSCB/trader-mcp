...
function createBaseCancelCalculateImpliedVolatility() {
    return { reqId: undefined };
}
export const CancelCalculateImpliedVolatility = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelCalculateImpliedVolatility();
    ...
    create(base) {
        return CancelCalculateImpliedVolatility.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelCalculateImpliedVolatility();
...
//# sourceMappingURL=CancelCalculateImpliedVolatility.js.map