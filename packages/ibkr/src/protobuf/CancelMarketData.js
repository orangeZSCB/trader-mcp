...
function createBaseCancelMarketData() {
    return { reqId: undefined };
}
export const CancelMarketData = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelMarketData();
    ...
    create(base) {
        return CancelMarketData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelMarketData();
...
//# sourceMappingURL=CancelMarketData.js.map