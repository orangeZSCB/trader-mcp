...
function createBaseCancelPnLSingle() {
    return { reqId: undefined };
}
export const CancelPnLSingle = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelPnLSingle();
    ...
    create(base) {
        return CancelPnLSingle.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelPnLSingle();
...
//# sourceMappingURL=CancelPnLSingle.js.map