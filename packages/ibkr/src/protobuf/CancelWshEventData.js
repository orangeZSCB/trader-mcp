...
function createBaseCancelWshEventData() {
    return { reqId: undefined };
}
export const CancelWshEventData = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelWshEventData();
    ...
    create(base) {
        return CancelWshEventData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelWshEventData();
...
//# sourceMappingURL=CancelWshEventData.js.map