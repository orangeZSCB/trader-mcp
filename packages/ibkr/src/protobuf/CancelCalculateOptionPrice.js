...
function createBaseCancelCalculateOptionPrice() {
    return { reqId: undefined };
}
export const CancelCalculateOptionPrice = {
    ...
    create(base) {
        return CancelCalculateOptionPrice.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelCalculateOptionPrice();
...
//# sourceMappingURL=CancelCalculateOptionPrice.js.map