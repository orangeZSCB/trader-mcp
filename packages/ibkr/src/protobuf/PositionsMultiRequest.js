...
function createBasePositionsMultiRequest() {
    return { reqId: undefined, account: undefined, modelCode: undefined };
}
export const PositionsMultiRequest = {
    ...
    decode(input, length) {
        ...
        const message = createBasePositionsMultiRequest();
    ...
    create(base) {
        return PositionsMultiRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePositionsMultiRequest();
...
//# sourceMappingURL=PositionsMultiRequest.js.map