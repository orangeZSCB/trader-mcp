...
function createBaseCancelHistoricalData() {
    return { reqId: undefined };
}
export const CancelHistoricalData = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelHistoricalData();
    ...
    create(base) {
        return CancelHistoricalData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelHistoricalData();
...
//# sourceMappingURL=CancelHistoricalData.js.map