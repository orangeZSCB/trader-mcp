...
function createBaseOpenOrder() {
    return { orderId: undefined, contract: undefined, order: undefined, orderState: undefined };
}
export const OpenOrder = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.orderState !== undefined) {
            OrderState.encode(message.orderState, writer.uint32(34).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return OpenOrder.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseOpenOrder();
