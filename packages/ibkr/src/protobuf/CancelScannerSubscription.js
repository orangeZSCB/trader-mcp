...
function createBaseCancelScannerSubscription() {
    return { reqId: undefined };
}
export const CancelScannerSubscription = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelScannerSubscription();
    ...
    create(base) {
        return CancelScannerSubscription.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelScannerSubscription();
...
//# sourceMappingURL=CancelScannerSubscription.js.map