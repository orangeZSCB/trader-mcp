...
function createBaseCancelWshMetaData() {
    return { reqId: undefined };
}
export const CancelWshMetaData = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelWshMetaData();
    ...
    create(base) {
        return CancelWshMetaData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelWshMetaData();
...
//# sourceMappingURL=CancelWshMetaData.js.map