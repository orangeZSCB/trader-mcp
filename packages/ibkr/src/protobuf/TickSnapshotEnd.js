...
function createBaseTickSnapshotEnd() {
    return { reqId: undefined };
}
export const TickSnapshotEnd = {
    ...
    decode(input, length) {
        ...
        const message = createBaseTickSnapshotEnd();
    ...
    create(base) {
        return TickSnapshotEnd.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTickSnapshotEnd();
...
//# sourceMappingURL=TickSnapshotEnd.js.map