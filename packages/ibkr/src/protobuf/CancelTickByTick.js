...
function createBaseCancelTickByTick() {
    return { reqId: undefined };
}
export const CancelTickByTick = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelTickByTick();
    ...
    create(base) {
        return CancelTickByTick.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelTickByTick();
...
//# sourceMappingURL=CancelTickByTick.js.map