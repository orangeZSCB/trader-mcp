...
function createBaseSecDefOptParameterEnd() {
    return { reqId: undefined };
}
export const SecDefOptParameterEnd = {
    ...
    decode(input, length) {
        ...
        const message = createBaseSecDefOptParameterEnd();
    ...
    create(base) {
        return SecDefOptParameterEnd.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSecDefOptParameterEnd();
...
//# sourceMappingURL=SecDefOptParameterEnd.js.map