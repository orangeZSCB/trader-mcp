...
function createBaseContractDataEnd() {
    return { reqId: undefined };
}
export const ContractDataEnd = {
    ...
    decode(input, length) {
        ...
        const message = createBaseContractDataEnd();
    ...
    create(base) {
        return ContractDataEnd.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseContractDataEnd();
...
//# sourceMappingURL=ContractDataEnd.js.map