...
function createBaseCancelFundamentalsData() {
    return { reqId: undefined };
}
export const CancelFundamentalsData = {
    ...
    create(base) {
        return CancelFundamentalsData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelFundamentalsData();
...
//# sourceMappingURL=CancelFundamentalsData.js.map