...
function createBaseCancelHeadTimestamp() {
    return { reqId: undefined };
}
export const CancelHeadTimestamp = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelHeadTimestamp();
    ...
    create(base) {
        return CancelHeadTimestamp.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelHeadTimestamp();
...
//# sourceMappingURL=CancelHeadTimestamp.js.map