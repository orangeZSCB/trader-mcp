...
function createBaseCancelRealTimeBars() {
    return { reqId: undefined };
}
export const CancelRealTimeBars = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelRealTimeBars();
    ...
    create(base) {
        return CancelRealTimeBars.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelRealTimeBars();
...
//# sourceMappingURL=CancelRealTimeBars.js.map