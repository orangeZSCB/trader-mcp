...
function createBaseCancelContractData() {
    return { reqId: undefined };
}
export const CancelContractData = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelContractData();
    ...
    create(base) {
        return CancelContractData.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelContractData();
...
//# sourceMappingURL=CancelContractData.js.map