...
function createBaseCancelPositionsMulti() {
    return { reqId: undefined };
}
export const CancelPositionsMulti = {
    ...
    decode(input, length) {
        ...
        const message = createBaseCancelPositionsMulti();
    ...
    create(base) {
        return CancelPositionsMulti.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseCancelPositionsMulti();
...
//# sourceMappingURL=CancelPositionsMulti.js.map