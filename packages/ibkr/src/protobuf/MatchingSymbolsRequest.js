...
function createBaseMatchingSymbolsRequest() {
    return { reqId: undefined, pattern: undefined };
}
export const MatchingSymbolsRequest = {
    ...
    decode(input, length) {
        ...
        const message = createBaseMatchingSymbolsRequest();
    ...
    create(base) {
        return MatchingSymbolsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMatchingSymbolsRequest();
...
//# sourceMappingURL=MatchingSymbolsRequest.js.map