...
export const RerouteMarketDepthRequest = {
    ...
    decode(input, length) {
        ...
        const message = createBaseRerouteMarketDepthRequest();
    ...
    create(base) {
        return RerouteMarketDepthRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRerouteMarketDepthRequest();
...
//# sourceMappingURL=RerouteMarketDepthRequest.js.map