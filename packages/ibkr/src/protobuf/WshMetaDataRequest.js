...
function createBaseWshMetaDataRequest() {
    return { reqId: undefined };
}
export const WshMetaDataRequest = {
    ...
    decode(input, length) {
        ...
        const message = createBaseWshMetaDataRequest();
    ...
    create(base) {
        return WshMetaDataRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseWshMetaDataRequest();
...
//# sourceMappingURL=WshMetaDataRequest.js.map