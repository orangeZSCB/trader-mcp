...
function createBasePositionMultiEnd() {
    return { reqId: undefined };
}
export const PositionMultiEnd = {
    ...
    decode(input, length) {
        ...
        const message = createBasePositionMultiEnd();
    ...
    create(base) {
        return PositionMultiEnd.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBasePositionMultiEnd();
...
//# sourceMappingURL=PositionMultiEnd.js.map