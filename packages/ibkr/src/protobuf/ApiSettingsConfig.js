...
function createBaseApiSettingsConfig() {
    return {
...
export const ApiSettingsConfig = {
    ...
    fromJSON(object) {
        return {
            ...
            trustedIPs: globalThis.Array.isArray(object?.trustedIPs)
                ? object.trustedIPs.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
...
//# sourceMappingURL=ApiSettingsConfig.js.map