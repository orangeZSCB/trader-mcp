...
import { VolumeCondition, PercentChangeCondition, PriceCondition, TimeCondition, MarginCondition, ExecutionCondition, TriggerMethodEnum, Create, OrderCondition, } from '../src/order-condition.js';
describe('OrderCondition', () => {
    it('can construct all condition types', () => {
        ...
        const price = new PriceCondition(TriggerMethodEnum.DoubleLast, 2222, 'NASDAQ', false, 4.75);
    ...
    it('encode/decode round-trip via makeFields/decode', () => {
        ...
        const vol2 = Create(OrderCondition.Volume);
...
//# sourceMappingURL=order-condition.spec.js.map